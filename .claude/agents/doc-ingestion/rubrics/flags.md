...
| Portfolio fee component > 50 bps (0.50% p.a.) | BREACH | HIGH | fees |
...
| Single holding weight > 20% | BREACH | HIGH | asset_allocation |
| Back-test or liquidity test absent | MISSING | HIGH | documentation |
| Disclosure text exceeds `max_words` from schema | BREACH | MEDIUM | disclosure |
| FUM recorded without `as_at` date | MISSING | HIGH | strategy |
