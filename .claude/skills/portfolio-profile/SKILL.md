...
4.  
4. **Generate Portfolio Profile**: Compile all portfolio profiles into one word document. Each portfolio profile use the template  @skills\portfolio-profile\template\Managed Portfolio Profile Template.docx
...
**File location**: The portfolio profile will be generated as a Word document and saved in the following location: @aiagent\skills\portfolio-profile\output\Managed Portfolio Profile - [Portfolio Series Name] - [Date].docx