...
ONLY return a Excel workbook contains the following three tabs. DO NOT include any other content in the response.
...
## Output 
The fee analysis will be generated as an Excel workbook and saved in the following location: 
- .codex\output\<YYYYMMDD>\Fee Analysis - [Portfolio Series Name] - [Date].xlsx
