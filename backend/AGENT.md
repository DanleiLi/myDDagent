...
This is the FastAPI service for Investment Governance Review Agent. 
...
See universal policy. Backend-specific:
...
│   ├── database/        # SQLAlchemy models, Supabase client wrapper, database helpers
